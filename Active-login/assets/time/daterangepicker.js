...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.parentEl = '.filter-time';

        //element that triggered the date range picker
        this.element = $(element);

        //create the picker HTML object
        var DRPTemplate = '<div class="daterangepicker dropdown-menu" style="left: -10px; top: 30px;">' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i><img src=assets/img/icon-date-left.png /></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i><img src=assets/img/icon-date-right.png /></i></th>';
            } else {
                html += '<th></th>';
            }
